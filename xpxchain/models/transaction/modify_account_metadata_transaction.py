"""
    modify_address_metadata_transaction
    =========================

    Modify address metadata transaction.
...
__all__ = [
    ...
    'ModifyAccountMetadataInnerTransaction',
]
...
@register_transaction('MODIFY_ACCOUNT_METADATA')
class ModifyAccountMetadataTransaction(Transaction):
    """
    Modify address metadata transaction.
    ...
    :param metadata_id: mosaic or namespace ID for which metadata is modified (used only when address is not specified)
    ...
    def create(
        ...
        :param deadline: Deadline to include transaction.
        :param metadata_type: type of the metadata
        :param metadata_id: address for which metadata is modified
        :param modifications: the modification to make
        :param network_type: Network type.
        ...
        return cls(
            network_type,
            TransactionType.MODIFY_ACCOUNT_METADATA,
            TransactionVersion.MODIFY_ACCOUNT_METADATA,
            deadline,
            metadata_type,
            metadata_id,
            modifications,
    ...
    def catbuffer_size_specific(self) -> int:
        ...
        metadata_id_size = Recipient.CATBUFFER_SIZE
    ...
    def to_catbuffer_specific(
        ...
        metadata_id = Recipient.to_catbuffer(self.metadata_id, network_type)
    ...
    def load_dto_specific(
        ...
        metadata_id = Recipient.create_from_dto(data['metadataId'], network_type)
...
@register_transaction('MODIFY_ACCOUNT_METADATA')
class ModifyAccountMetadataInnerTransaction(InnerTransaction, ModifyAccountMetadataTransaction):
